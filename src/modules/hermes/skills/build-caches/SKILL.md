...
## Attic (vm-110, http://10.100.0.110:8080, https://attic.lsck0.dev, cache `homelab`)
...
## sccache (vm-111, redis://10.100.0.111:6379)

Shared Rust/C/C++ compile cache for CI (`SCCACHE_REDIS=redis://sccache.lsck0.dev`).
- Stats: `ssh 10.100.0.111 redis-cli -p 6379 info memory`; flush if corrupt: `redis-cli -p 6379 flushall`.
