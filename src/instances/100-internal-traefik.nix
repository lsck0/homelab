    ...
    dynamicConfigOptions = {
      ...
      http = {
        ...
        routers = {
          ...
          headscale-local-tls      = { rule = "Host(`hs.internal.local`)";         service = "headscale";       entryPoints = [ "websecure" ]; tls = { options = "default"; }; };
        ...
        services = {
          ...
          grafana.loadBalancer.servers        = [{ url = ip "116"; }];
          wikijs.loadBalancer.servers         = [{ url = ip "117"; }];
          audiobookshelf.loadBalancer.servers = [{ url = ip "118"; }];
          headscale.loadBalancer.servers      = [{ url = ip "119"; }];
          qbittorrent.loadBalancer.servers    = [{ url = ip "120"; }];
          prowlarr.loadBalancer.servers       = [{ url = ip "121"; }];
          sonarr.loadBalancer.servers         = [{ url = ip "122"; }];
          radarr.loadBalancer.servers         = [{ url = ip "123"; }];
